...
class _SideMenuItemState extends State<SideMenuItemWithGlobal> {
  late String currentPage = widget.global.controller.currentPage;
  ...
  void _handleChange(String page) {
    safeSetState(() {
      currentPage = page;
    });
  }
  ...
  String _getIndexOfCurrentSideMenuItemWidget() {
    int index = 0;
  ...
  Widget _generateIcon(Icon? mainIcon, Widget? iconWidget, String? page) {
    if (mainIcon == null) return iconWidget ?? const SizedBox();
    final Color iconColor = _isSelected(page)
    ...
    if (widget.builder == null) {
      return InkWell(
        onTap: () => widget.onTap?.call(
            widget.page ?? _getIndexOfCurrentSideMenuItemWidget(),
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        _generateIcon(
                            widget.icon, widget.iconWidget, widget.page),
